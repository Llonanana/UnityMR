    ...
    void InitSummaryCSV()
    {
        if (!File.Exists(summaryCSVPath))
        {
            string header = "UserID,TestTime,SelectedSeconds," +
                "Introvert_NPC_Count,Introvert_NPC_Duration," +
                "Introvert_Exhibit_Count,Introvert_Exhibit_Duration," +
                "Extrovert_NPC_Count,Extrovert_NPC_Duration," +
                "Extrovert_Exhibit_Count,Extrovert_Exhibit_Duration";
